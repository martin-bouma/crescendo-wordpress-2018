        ...
        <form name="form1" method="post" action="">
            ...
            <div id="cff_fb_login_modal">
                <div class="cff_modal_box">
                    ...
                    <a href="https://smashballoon.com/custom-facebook-feed/app-login/?state=<?php echo $admin_url_state; ?>" class="cff_admin_btn"><i class="fa fa-facebook-square"></i> <?php _e( 'Continue', 'custom-facebook-feed' ); ?></a></p>                    
